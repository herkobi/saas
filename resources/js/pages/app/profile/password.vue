...
import { update } from '@/routes/app/profile/password';
...
<template>
    <AppLayout title="Şifre Değiştir">
        <div class="mx-auto max-w-2xl">
            ...
            <form @submit.prevent="submit" class="flex flex-col gap-4">
                ...
                <div class="flex justify-end">
                    <Button type="submit" label="Şifreyi Güncelle" icon="pi pi-lock" :loading="form.processing" />
                </div>
            </form>
        </div>
    </AppLayout>
