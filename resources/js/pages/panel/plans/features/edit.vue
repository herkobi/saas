...
const submit = () => {
    form.put(`/panel/plans/features/${props.feature.id}`);
};
</script>

<template>
    <PanelLayout title="Özellik Düzenle">
        <div class="mx-auto max-w-2xl flex flex-col gap-6">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-xl font-semibold text-surface-900 dark:text-surface-0">{{ feature.name }}</h2>
            </div>
                    ...
                    <form @submit.prevent="submit" class="flex flex-col gap-4">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div class="flex flex-col gap-2">
                                ...
                                <Select id="type" v-model="form.type" :options="featureTypes" optionLabel="label" optionValue="value" fluid />
                            </div>
