...
/**
 * Panel Two Factor Authentication Request
 *
 * This form request handles authorization and validation for panel user
...
/**
 * Form request for panel two-factor authentication page.
 *
