...
/**
 * Panel Password Updated Notification
 *
 * This notification is sent when a panel user's password is successfully changed.
 * It sends both database and mail notifications to inform the user about
 * the password change for security purposes.
 *
 * @package    App\Notifications\Panel\Profile
 * @author     Herkobi
...
use App\Mail\Panel\Profile\PasswordUpdatedMail;
use Illuminate\Bus\Queueable;
use Illuminate\Contracts\Queue\ShouldQueue;
use Illuminate\Notifications\Notification;

/**
 * Notification for panel password updates.
 *
